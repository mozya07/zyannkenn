...
public class BattleView extends AppCompatActivity {
    ...
    private int soundnaguru, soundaiuchi, soundokinnkyuu;
...
hagut.setImageResource(R.drawable.hagutt);
        ...
        //　GameDataに追加するデータ
        ary.add(new GameData("ドロイド", 100, "ドロイドが現れた！！", 1));
        ary.add(new GameData("ドロイド", 50, "5ダメージ与えた", 2));
        ary.add(new GameData("ドロイド", 0, "5ダメージ与えた", 3));
        ary.add(new GameData("ドロイドゴン", 100, "ドロイドゴンが現れた！！", 4));
        ary.add(new GameData("ドロイドゴン", 67, "15ダメージ与えた", 5));
        ary.add(new GameData("ドロイドゴン", 34, "15ダメージ与えた", 6));
        ary.add(new GameData("ドロイドゴン", 0, "20ダメージ与えた", 7));
        ary.add(new GameData("ドロイドドラゴン", 100, "ドロイドドラゴンが現れた！！", 8));
        ary.add(new GameData("ドロイドドラゴン", 75, "25ダメージ与えた", 9));
        ary.add(new GameData("ドロイドドラゴン", 50, "25ダメージ与えた", 10));
        ary.add(new GameData("ドロイドドラゴン", 25, "25ダメージ与えた", 11));
        ary.add(new GameData("ドロイドドラゴン", 0, "25ダメージ与えた", 12));
        ary.add(new GameData("[Androidの支配者]ドロイド神", 100, "ドロイド神が異次元から現れた", 13));
        ary.add(new GameData("[Androidの支配者]ドロイド神", 80, "20ダメージ与えた", 14));
        ary.add(new GameData("[Androidの支配者]ドロイド神", 60, "20ダメージ与えた", 15));
        ary.add(new GameData("[Androidの支配者]ドロイド神", 40, "20ダメージ与えた", 16));
        ary.add(new GameData("[Androidの支配者]ドロイド神", 20, "20ダメージ与えた", 17));
        ary.add(new GameData("[Androidの支配者]ドロイド神", 0, "20ダメージ与えた", 18));
        ...
        enemyhand.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (gameoversituationtxt.equals("タップすると戻ります") || gameoversituationtxt.equals("You are a great player")) {
                    Intent intent = new Intent(BattleView.this, DungeonSelectView.class);
        ...
        hagu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(BattleView.this);
                ...
                builder.setPositiveButton("諦める", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(BattleView.this, "撤退しました", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
                builder.setNegativeButton("バトルに戻る", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(BattleView.this, "バトルを再開します", Toast.LENGTH_SHORT).show();
                    }
                });
                builder.show();
            }
    ...
    private void monsterViewChange() {
        // モンスターの画像データ
        int[] monsterChangeData = { R.drawable.doroido, R.drawable.doroido4, R.drawable.doroido5,
        R.drawable.doroidogonn, R.drawable.doroidogonn2, R.drawable.doroidogonn4, R.drawable.doroidogonn5,
        R.drawable.doroidoragonn, R.drawable.doroidoragonn1, R.drawable.doroidoragonn2,
                R.drawable.doroidoragonn4, R.drawable.doroidoragonn5,
        R.drawable.doroidosinn, R.drawable.doroidosinn1, R.drawable.doroidosinn2,
                R.drawable.doroidosinn3, R.drawable.doroidosinn4, R.drawable.doroidosinn5};
